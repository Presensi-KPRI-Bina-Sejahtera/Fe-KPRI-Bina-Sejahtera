      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-md">
            Silakan masukkan data toko baru. Pin lokasi di peta untuk mengisi alamat otomatis.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 rounded-lg border p-4 bg-slate-50/50">
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="bg-white" 
              />
              <p className="text-xs text-muted-foreground">Radius pegawai bisa melakukan absen dari titik lokasi.</p>
            </div>
          </div>
        </div>
